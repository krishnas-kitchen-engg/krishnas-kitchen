...
lifecycle: living
owner: engineering
update_cadence: when documentation governance changes
last_reviewed: null
related:
  - ../README.md
  - ../conventions.md
...
Governance explains how handbook documents become trusted, stay current, and avoid conflicting sources of truth.
...
This section landing page is living documentation. Future governance policy pages may be living or historical depending on their purpose.

## Who Updates It

Engineering owns governance. Area owners should participate when governance affects their documentation.

## When To Update It

Update this section when:

- Documentation lifecycle rules change.
