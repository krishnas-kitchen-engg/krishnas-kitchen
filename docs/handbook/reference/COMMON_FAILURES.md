...
| Debug instrumentation remains in auth flow | Diagnostic work was left in dirty app files | Review and resolve the temporary volunteer login diagnostic candidate | Check dirty worktree during repository audit |
