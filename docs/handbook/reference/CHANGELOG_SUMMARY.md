...
| Recipe definition domain foundation | Added the first Horizon 1 recipe domain foundation with recipe input types, ingredient validation, serving/yield validation, normalization, recipe-specific validation errors, exports, and focused tests without adding UI, persistence, migrations, or higher-horizon behavior | [Current Milestone](./CURRENT_MILESTONE.md); [Current State](./CURRENT_STATE.md); [Evidence Report](./EVIDENCE_REPORT.md) |
| Engineering Operating System reporting refinement | Distinguished milestone-specific Residual Risks from intentionally deferred Future Approved Work in completion reporting guidance, Definition of Done, post-implementation review templates, and evidence reporting without changing workflow behavior | [AI Engineering Operating Model](../governance/AI_ENGINEERING_OPERATING_MODEL.md); [Definition of Done](../process/DEFINITION_OF_DONE.md); [Evidence Report](./EVIDENCE_REPORT.md) |
| Recipe scaling domain foundation | Added pure recipe scaling logic that validates and normalizes a base recipe, scales ingredient quantities to target servings, rounds to six decimal places, and preserves item references, units, and notes without adding UI, persistence, availability checks, or shopping-list behavior | [Current Milestone](./CURRENT_MILESTONE.md); [Current State](./CURRENT_STATE.md); [Evidence Report](./EVIDENCE_REPORT.md) |
| Recipe availability domain foundation | Added pure recipe availability logic that validates and normalizes recipe input, compares ingredients with projected inventory item balances by exact item/unit match, reports available/short/missing status, and prevents duplicate ingredient lines from reusing the same available quantity without adding UI, persistence, unit conversion, or shopping-list behavior | [Current Milestone](./CURRENT_MILESTONE.md); [Current State](./CURRENT_STATE.md); [Evidence Report](./EVIDENCE_REPORT.md) |
| Recipe shopping-list domain foundation | Added pure recipe shopping-list logic that consumes availability results, groups shortage-only item/unit outputs, preserves required/available/shortage quantities, and avoids UI, persistence, unit conversion, vendor, approval, or procurement behavior | [Current Milestone](./CURRENT_MILESTONE.md); [Current State](./CURRENT_STATE.md); [Evidence Report](./EVIDENCE_REPORT.md) |
| Recipe repository contract foundation | Added a recipe application-layer repository contract for scoped list/read access and focused tests proving repository records remain compatible with recipe scaling, availability, and shopping-list domain functions without adding Supabase adapters, migrations, RLS/RPC, UI, or persistence behavior | [Current Milestone](./CURRENT_MILESTONE.md); [Current State](./CURRENT_STATE.md); [Evidence Report](./EVIDENCE_REPORT.md) |
| Delivery Management handbook freeze | Added the separate Delivery Management handbook for product-facing capability tracking, delivery status, and readiness assessment without changing application code, the Engineering Operating System, or Product Horizons | [Delivery Model](../../delivery/DELIVERY_MODEL.md); [Capability Matrix](../../delivery/CAPABILITY_MATRIX.md); [Delivery Status](../../delivery/DELIVERY_STATUS.md); [Delivery Readiness](../../delivery/DELIVERY_READINESS.md); [Evidence Report](./EVIDENCE_REPORT.md) |
