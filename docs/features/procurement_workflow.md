...
- Configure reorder points, minimum order quantities, purchase units, pack sizes, and estimated costs.
...
- Generate purchase lists by store/source or by purchaser.
...
- Requested quantity.
- Approved quantity.
- Generation grouping: by purchase location or by purchaser.
- Unit.
- Purchase location.
- Assigned purchaser.
- Status.
...
Status: Complete for approver review, quantity/unit/notes edits, approver-added items, removal from approved queue, audited consolidation, manual publish, scheduled publish intent, due scheduled publish, and list generation grouped by store/source or purchaser.
...
| Purchase list can be generated by store/source or purchaser | Approver View | Slice 4 | Complete |
...
| Item reorder points and minimum order quantities are admin-configurable | Admin View | Slice 2 | Complete |
