...
export function ReceiveBarcodeEntry({
  error,
  format,
  isLoading,
  onFormatChange,
  ...
  return (
    <section className="space-y-3 rounded-md border border-stone-200 bg-white p-4">
      <div>
        ...
        <p className="mt-1 text-sm text-stone-600">Enter a barcode value from the package.</p>
      </div>
