import type { InventoryCatalogLocation, ReturnResolvedItem } from "@/domains/inventory";
...
export function ReturnConfirmation({
  ...
  return (
    <section className="space-y-4 rounded-md border border-stone-200 bg-white p-4">
      <div>
        <h2 className="text-base font-semibold text-stone-950">Confirm return</h2>
        <p className="mt-1 text-sm text-stone-600">Review before creating the return event.</p>
      </div>
      <dl className="space-y-2 text-sm">
        ...
        <div className="flex justify-between gap-4">
          <dt className="text-stone-600">Back to</dt>
          <dd className="text-right font-semibold text-stone-950">
